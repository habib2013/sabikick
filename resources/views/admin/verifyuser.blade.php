              ...
              <div class="btn-group btn-group-nav shadow ml-auto" role="group" aria-label="Basic example">
                ...
                <div class="btn-group" role="group">
                  ...
                  <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow" aria-labelledby="btn-group-boards">
                    <a class="dropdown-item" href="/posts/create">Blog Post</a>
              ...
              <div class="col-6 col-md-auto d-flex justify-content-between align-items-center">
                ...
                <div class="dropdown ml-2">
                  ...
                  <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <button class="btn btn-primary open-modal" value="{{$user->id}}"><span class="far fa-eye"></span>
                            </button>   
                       
               
                      
                    </a>
                    <a href="/{{$user->username}}" target="_blank" class="dropdown-item">
                  

                            <button type="button" value="{{$user->id}}" class="btn btn-primary" ><span class="far fa-user"></span></button>

                    </a>
                    <a href="#!" class="dropdown-item">
                    <button class="btn btn-danger" ><span class="far fa-trash"></span>
                            </button>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="form-control-label">Verify/Disable/Suspended</label>
...
<div class="modal fade docs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h5 class="modal-title h6" id="myLargeModalLabel">Complete Profile</h5>
