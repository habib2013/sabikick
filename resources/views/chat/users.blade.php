    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-primary">
                ...
                <a onclick="seenUpdate()" style="color:#000000;text-decoration:none; margin-left: 12px;" href="{{URL::to('/allmessages')}}"> 
                ...
                <a style="color:#000000;text-decoration:none; margin-left: 12px;" href="{{URL::to('/users')}}"> 
                     <span class="far fa-user"></span> User
                </a>
                </a>
                <a style="color:#000000; text-decoration:none;    margin-left: 12px;" href="{{URL::to('/')}}"> 
                     <span class="far fa-search"></span> Search 
                </a>
