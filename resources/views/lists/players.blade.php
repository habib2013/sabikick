          ...
          <div class="row justify-content-between align-items-center">
            ...
            <div class="col text-right">
              <div class="actions"><a href="#" class="action-item mr-2" data-action="search-open" data-target="#actions-search"><i class="far fa-search"></i></a>
                ...
                <a onclick="seenUpdate()" class="action-item mr-2" href="{{URL::to('/allmessages')}}"> 
                ...
                </div><a href="/listplayers" class="action-item mr-2"><i class="far fa-sync"></i></a>
          ...
          <div class="card-body py-3">
            <div class="row flex-column flex-md-row align-items-center">
              ...
              <div class="col ml-md-n2 text-center text-md-left">
                <a href="{{URL::to('/message/'.$user->id)}}" class="h6 text-sm mb-0">{{$user->name}}</a>
