...
<!-- Mirrored from demo.webpixels.io/purpose-website-ui-kit-v2.0.1/pages/secondary/careers.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 10 Nov 2019 19:48:52 GMT -->
...
<body>
        ...
        <div class="navbar-nav align-items-center">
          ...
          <div class="ml-auto">
            <ul class="nav">
              ...
              <li class="nav-item">
                <a class="nav-link" href="../shop/checkout-cart.html"><i class="far fa-shopping-cart"></i></a>
              </li>
    ...
    <nav class="navbar navbar-main navbar-expand-lg navbar-transparent navbar-light bg-white" id="navbar-main">
      <div class="container px-lg-0">
        ...
        <a class="navbar-brand mr-lg-5" href="../../index-2.html">
          <img alt="Image placeholder" src="../../assets/img/brand/dark.png" id="navbar-logo" style="height: 50px;">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbar-main-collapse">
              ...
              <div class="dropdown-menu dropdown-menu-lg dropdown-menu-arrow p-0">
                <ul class="list-group list-group-flush">
                  ...
                  <li class="dropdown dropdown-animate dropdown-submenu" data-toggle="hover">
                    ...
                    <ul class="dropdown-menu">
                      <li>
                        <a class="dropdown-item" href="about-classic.html">
                          About classic
                        </a>
                      </li>
                      <li>
                      ...
                      <li>
                        <a class="dropdown-item" href="blog-article.html">
                          Blog article
                        </a>
                      </li>
                      <li>
                      ...
                      <li>
                        <a class="dropdown-item" href="careers-single.html">
                          Careers single
                        </a>
                      </li>
                      <li>
                      ...
                      <li>
                        <a class="dropdown-item" href="contact-simple.html">
                          Contact simple
                        </a>
                      </li>
                      <li>
                        <a class="dropdown-item" href="get-started.html">
                          Get started
                        </a>
                      </li>
                      <li>
                      ...
                      <li>
                        <a class="dropdown-item" href="portfolio-fullscreen.html">
                          Portfolio fullscreen
                        </a>
                      </li>
                      <li>
                        <a class="dropdown-item" href="pricing-charts.html">
                          Pricing charts
                        </a>
                      </li>
                      <li>
                        <a class="dropdown-item" href="pricing-comparison.html">
                          Pricing comparison
                        </a>
                      </li>
                      <li>
                        <a class="dropdown-item" href="pricing-simple.html">
                          Pricing simple
                        </a>
                      </li>
                      <li>
                  ...
                  <li class="dropdown dropdown-animate dropdown-submenu" data-toggle="hover">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li>
                        <a class="dropdown-item" href="../shop/shop-landing.html">
                          Landing
                        </a>
                      </li>
                      <li>
                        <a class="dropdown-item" href="../shop/shop-products.html">
                          Products
                        </a>
                      </li>
                      <li>
                        <a class="dropdown-item" href="../shop/shop-product.html">
                          Product
                        </a>
                      </li>
                      <li class="dropdown-divider"></li>
                      ...
                      <li>
                        <a class="dropdown-item" href="../shop/checkout-cart.html">
                          Cart
                        </a>
                      </li>
                      <li>
                        <a class="dropdown-item" href="../shop/checkout-cart-empty.html">
                          Cart empty
                        </a>
                      </li>
                      <li>
                        <a class="dropdown-item" href="../shop/checkout-customer.html">
                          Customer
                        </a>
                      </li>
                      <li>
                        <a class="dropdown-item" href="../shop/checkout-payment.html">
                          Payment
                        </a>
                      </li>
                      <li>
                        <a class="dropdown-item" href="../shop/checkout-shipping.html">
                          Shipping
                        </a>
                      </li>
                    </ul>
          ...
          <ul class="navbar-nav align-items-lg-center ml-lg-auto">
            ...
            <li class="nav-item mr-0">
              ...
              <a href="https://themes.getbootstrap.com/product/purpose-website-ui-kit/" target="_blank" class="btn btn-sm btn-primary btn-icon rounded-pill d-none d-lg-inline-flex" data-toggle="tooltip" data-placement="left" title="Go to Bootstrap Themes">
  ...
  <div class="main-content">
      ...
      <div class="container pt-5">
        <div class="row row-grid justify-content-center">
          <div class="col-lg-8 text-center">
            <h6 class="text-sm text-uppercase ls-2 text-muted font-weight-700">Careers</h6>
            <h2 class="h1 mb-4">Job openings</h2>
            <p class="lead lh-180">With we want to optimize the customization process so your team can save time when building websites.</p>
            <div class="mt-5">
              <a href="#" class="btn btn-primary rounded-pill px-5 mr-lg-4 my-2">Contact us</a>
              <a href="https://www.youtube.com/watch?v=mqpwDJpI3Rc" class="btn btn-outline-primary btn-icon rounded-pill px-4 my-2" data-fancybox>
        ...
        <div class="row row-grid pt-6 mt-6 delimiter-top">
          <div class="col-lg-4">
            <div class="d-flex align-items-center">
              <img alt="Image placeholder" src="{{asset('img/icons/essential/detailed/Ballance.svg')}}" class="svg-inject" style="width: 90px; height: 90px;">
          ...
          <div class="col-lg-4">
            <div class="d-flex align-items-center">
              <img alt="Image placeholder" src="{{asset('img/icons/essential/detailed/Charts_1.svg')}}" class="svg-inject" style="width: 90px; height: 90px;">
              <div class="icon-text px-4">
                <h5 class="mb-1">Intense growth</h5>
                <p class="mb-0">We give you the right tools so you can reach your potential.</p>
              </div>
            </div>
          </div>
          <div class="col-lg-4">
            <div class="d-flex align-items-start">
              <img alt="Image placeholder" src="{{asset('img/icons/essential/detailed/Group.svg')}}" class="svg-inject" style="width: 90px; height: 90px;">
              <div class="icon-text px-4">
                <h5 class="mb-1">Fantastic people</h5>
                <p class="mb-0">The best place to work is where your friends are.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row justify-content-center">
          <div class="col-lg-10">
              ...
              <table class="table table-hover table-scale--hover table-cards align-items-center">
                <tbody>
                  <tr>
                    ...
                    <td><i class="far fa-map-marker mr-3"></i><span class="h6">San Francisco, US</span></td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td><i class="far fa-map-marker mr-3"></i><span class="h6">Bucharest, RO</span></td>
                  </tr>
                  <tr class="table-divider"></tr>
                  <tr>
                    <th scope="row">
            ...
            <div class="text-center mt-5">
              <a href="#" class="text-white"><i class="far fa-angle-right mr-2"></i>View all job openings</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="slice slice-lg">
      <div class="container">
        <div class="mb-5 text-center">
          <h3 class=" mt-4">Working with companies wolrdwide</h3>
          <div class="fluid-paragraph mt-3">
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="card" data-animate-hover="1">
              <div class="animate-this">
                <img alt="Image placeholder" src="../../assets/img/theme/light/img-7-800x600.jpg" class="card-img-top">
                <a href="https://www.youtube.com/watch?v=mqpwDJpI3Rc" class="btn btn-lg btn-white btn-icon-only rounded-circle shadow-sm position-absolute right-4 top-4 hover-scale-110" data-fancybox>
                  <span class="btn-inner--icon">
                    <i class="far fa-play"></i>
                  </span>
              ...
              <div class="card-body">
                <blockquote class="blockquote">
                  ...
                  <div class="quote-text">
                    <p class="font-italic lh-170">Amazing template! All-in-one, clean code, beautiful design, and really not hard to work with.Highly recommended for any kind on website.</p>
                    <footer class="blockquote-footer">
                      Someone famous in <cite title="Source Title">Michael Wright</cite>
                    </footer>
                  </div>
                </blockquote>
              </div>
        ...
        <div class="mt-5 text-center">
          <a href="#" class="btn btn-sm btn-primary rounded-pill btn-icon">
            <span class="btn-inner--icon"><i class="far fa-angle-right"></i></span>
            <span class="btn-inner--text">See all stories</span>
          </a>
        </div>
      </div>
    </section>
